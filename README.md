...
[![Go Report Card](https://goreportcard.com/badge/github.com/skbkontur/oauth2-proxy)](https://goreportcard.com/report/github.com/skbkontur/oauth2-proxy)
[![GoDoc](https://godoc.org/github.com/skbkontur/oauth2-proxy?status.svg)](https://godoc.org/github.com/skbkontur/oauth2-proxy)
...
1.  Choose how to deploy:
    ...
    a. Download [Prebuilt Binary](https://github.com/skbkontur/oauth2-proxy/releases) (current release is `v7.3.0`)

    b. Build with `$ go get github.com/skbkontur/oauth2-proxy` which will put the binary in `$GOROOT/bin`
...
See [open redirect vulnerability](https://github.com/skbkontur/oauth2-proxy/security/advisories/GHSA-5m6c-jp6f-2vcv) for details.
