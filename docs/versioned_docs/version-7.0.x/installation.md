...
1.  Choose how to deploy:
    ...
    a. Download [Prebuilt Binary](https://github.com/skbkontur/oauth2-proxy/releases) (current release is `v7.0.1`)

    b. Build with `$ go get github.com/skbkontur/oauth2-proxy` which will put the binary in `$GOPATH/bin`
